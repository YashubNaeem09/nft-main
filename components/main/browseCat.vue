<template>
    <div
        ...
        <div class="topCreators grid grid-cols-10 md:grid-cols-4 lg:grid-cols-1 gap-4 ml-7 lg:ml-3">
            <div class="col-span-10 md:col-span-10 lg:col-span-12 flex lg:flex-row flex-col">
            ...
            <div
                class="col-span-12 md:col-span-8 lg:col-span-12 md:flex md:flex-col md:justify-content-center items-center lg:ml-auto md:ml-8 overflow-y-hidden">
                ...
                <div class="headRow1 flex lg:flex-row flex-col lg:ml-3">
                    ...
                    <div class="row2 flex lg:flex-col flex-row flex-wrap lg:-ml-6">
                        <Card
                            class="rounded-3xl bg-topColor text-white flex flex-col lg:w-15 lg:h-80 w-5 h-15 lg:my-0 my-3 lg:mx-3">
                            <template #header>
                        ...
                        <Card
                            ...
                            <template #title>
                                <h5 class="flex lg:text-start lg:pt-4 pt-0">Photography</h5>
                            </template>
                        </Card>
                    </div>
                </div>
                <div class="subRow2 flex lg:flex-row flex-col lg:ml-4">
                    ...
                    <Card class="rounded-3xl bg-topColor text-white flex flex-col lg:my-0 my-3 lg:w-15 lg:h-80 w-5 h-15 lg:mx-0 mx-3">
                        <template #header>
