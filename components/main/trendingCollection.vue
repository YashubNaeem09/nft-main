      ...
      <div class="col-span-10 md:col-span-8 lg:col-span-10 md:flex md:flex-row md:justify-content-between lg:ml-1 -ml-3">
        <div class="col lg:ml-28 mr-5">
          <div class="card rounded-3xl bg-themeColor text-white flex flex-col">
            ...
            <div class="cardContent py-1 flex flex-row text-white">
              <h1 class="text-2xl lg:text-2xl font-bold leading-normal lg:col-12 lg:leading-normal ml-3 lg:ml-2">DSGN
                Animals</h1>
            </div>
            <div class="flex flex-row text-white items-center">
              <img class="h-8 w-auto rounded-full object-center object-scale-down mx-3" src="images/avatarHero1.PNG"
                alt="" />
              <span class="text-1xl -py-1 font-bold text-white">Animkad</span>
            </div>
          </div>
        </div>
        <div class="col hidden lg:block">
          <div class="card rounded-3xl bg-themeColor text-white">
            ...
            <div class="cardContent py-1 flex flex-row text-white">
              <h1 class="text-2xl lg:text-2xl font-bold leading-normal lg:col-12 lg:leading-normal ml-3 lg:ml-2">Magic
                Mashrooms</h1>
            </div>
            <div class="flex flex-row text-white items-center">
              <img class="h-8 w-auto rounded-full object-center object-scale-down mx-3" src="images/avatarHero1.PNG"
                alt="" />
              <span class="text-1xl -py-1 font-bold text-white">Shroomie</span>
            </div>
          </div>
        </div>
        <div class="col lg:ml-4 hidden xl:block">
          <div class="card rounded-3xl bg-themeColor text-white">
            ...
            <div class="cardContent py-1 flex flex-row text-white">
              <h1 class="text-2xl lg:text-2xl font-bold leading-normal lg:col-12 lg:leading-normal ml-3 lg:ml-2">Disco
                Machines</h1>
            </div>
            <div class="flex flex-row text-white items-center">
              <img class="h-8 w-auto rounded-full object-center object-scale-down mx-3" src="images/avatarHero1.PNG"
                alt="" />
              <span class="text-1xl -py-1 font-bold text-white">BeKind2Robots</span>
            </div>
          </div>
        </div>
      </div>
