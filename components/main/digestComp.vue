                ...
                <div class="row1 flex lg:flex-row flex-col bg-themeColor lg:bg-topColor rounded-3xl h-auto w-auto lg:ml-3">
                    <div class="py-4 h-auto w-auto flex lg:flex-row flex-col">
                        ...
                        <div class="content lg:py-4 lg:ml-8 ml-6 text-left text-white left-6 flex flex-col justify-content-left">
                            ...
                            <div class="inputField  text-dark flex lg:flex-row flex-col lg:col-8 col-11">
                                <InputGroup class="rounded-2xl bg-white col-span-1">
                                    <InputText placeholder="Enter Your Email Here" class="ml-2 rounded-l-3xl focus:outline-none text-black"  style="box-shadow: none; border-color: #ccc;"/>
                                    <InputGroupAddon class="buttonModel cursor-pointer lg:ml-6 text-white lg:px-6 lg:py-3 px-6 py-3">
