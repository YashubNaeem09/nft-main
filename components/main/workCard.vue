            ...
            <div
                ...
                <div class="row1 flex lg:flex-row flex-col lg:ml-8 md:ml-2 sm:ml-3 sm:mr-3">
                    <Card
                        ...
                        <template #title>
                            <h1 class="flex lg:items-center lg:justify-content-center lg:pt-0 pt-6 lg:ml-0 ml-3">Setup Your Wallet</h1>
                        </template>
                        <template #subtitle>
                            <div class="flex lg:items-center lg:justify-content-center justify-content-left col-12 ml-2">
                    ...
                    <Card
                        ...
                        <template #title>
                            <h1 class="flex lg:items-center lg:justify-content-center lg:pt-0 pt-6 lg:ml-0 ml-3">Create Collection</h1>
                        </template>
                        <template #subtitle>
                            <div class="flex lg:items-center lg:justify-content-center justify-content-left col-12 ml-2">
                    ...
                    <Card
                        ...
                        <template #title>
                            <h1 class="flex lg:items-center lg:justify-content-center lg:pt-0 pt-6 lg:ml-0 ml-3">Start Earning</h1>
                        </template>
                        <template #subtitle>
                            <div class="flex lg:items-center lg:justify-content-center justify-content-left col-12 ml-2">
